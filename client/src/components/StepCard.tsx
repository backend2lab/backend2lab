            ...
            <div className="flex flex-wrap gap-2">
              {links.map((link, index) => (
                <a
                  ...
                  className="btn-b2l-secondary text-theme-primary hover:bg-slate-100 dark:hover:bg-neutral-800 text-sm px-3 py-2 flex items-center gap-1 rounded transition-colors"
                >
                  {link.text}
                  {link.external && (
